...
export default function Select(props) {
  ...
  const sendMail = (event) => {
    ...
    if (window.Email) {
      window.Email.send({
        SecureToken: "093fdb3e-496a-4806-b4f9-420875b80e2a",
        To: Window.valMail,
        From: "tmohamedaashir@gmail.com",
        Subject: document.getElementById("subject").value,
        Body: document.getElementById("body").value,
      }).then(alert(Window.valNo + " mails sent successfully"));
    }
  };
  ...
  return (
    ...
    <div className="border-2 mx-3 lg:mx-auto lg:my-20 font-poppins flex flex-col items-center mt-16 lg:w-[900px] p-7 rounded-lg bg-white">
      ...
      <p className="mt-10 text-gray-500 text-center lg:w-[700px]">
        Select the file consisting of all the email IDs to which the mail has to
        be sent. MailPilot will automatically detect and filter the valid and
        invalid email IDs.
        <br /> (Required file format : .csv)*
      </p>
      ...
      <div className="choose mt-10">
        ...
        <div className="label-input">
          <label
            htmlFor="select-file"
            className="bg-cherryred-100 shadow-xl shadow-gray-500/50 text-xl w-60 h-16 rounded-lg flex items-center justify-center text-white cursor-pointer active:bg-hoverblack-100 lg:hover:bg-hoverblack-100 lg:active:bg-cherryred-100"
          >
            <svg
              className="mr-2"
              stroke="currentColor"
        ...
        <div className="selected-file hidden">
          <div className="fileName text-gray-500 mt-5 flex justify-between items-center w-56 border-2 p-3 rounded-lg">
            ...
            <button onClick={resetFile}>
              <i className="fa-solid fa-x text-cherryred-100"></i>
            </button>
          </div>
        </div>
        ...
        <div className="validate mt-14 hidden">
          ...
          >
            VALIDATE<i className="fa-solid fa-arrow-right ml-2"></i>
          </button>
        </div>
        ...
        <div className="send-mail mt-14 hidden">
          <Popup
            trigger={
              <button className="bg-cherryred-100 shadow-xl shadow-gray-500/50 text-xl w-60 h-16 rounded-lg flex items-center justify-center text-white cursor-pointer active:bg-hoverblack-100 lg:hover:bg-hoverblack-100 lg:active:bg-cherryred-100">
                <svg
                  stroke="currentColor"
                  fill="none"
                  strokeWidth="2"
              ...
              <div className="border-2 mx-3 lg:mx-auto lg:my-20 font-poppins mt-16 lg:w-[700px] p-7 rounded-lg bg-white ">
                <div className="flex justify-end mb-5">
                  <button onClick={() => close()}>
                    <i className="fa-solid fa-xmark text-2xl text-cherryred-100"></i>
                  </button>
                </div>
                <div className="flex justify-center">
                  ...
                  >
                    <h1 className="text-4xl text-center">Compose Mail</h1>
                    <p className="text-gray-500">
                      This mail will be sent to all the valid email IDs
                    </p>
                    <input
                      className="border-2 border-gray-500 rounded-lg w-64 m-auto p-2 text-sm"
                      placeholder="Subject"
                      name="subject"
                      id="subject"
                      type="text"
                    ...
                    <p className="text-gray-500 text-sm text-center">
                      Note: Maximum of 100 mails can be sent at once
                    </p>
                    <button
                      id="submit"
                      type="submit"
                      className="bg-cherryred-100 border-2 border-cherryred-100 text-white rounded-lg w-28 m-auto p-2 shadow-lg hover:bg-white hover:text-cherryred-100 hover:border-cherryred-100"
                    >
              ...
              <tr>
                <td>
                  <h2 className="font-bold text-lg">
                    ...
                    <span
                      id="valCount"
                      className="text-cherryred-100 text-lg font-bold"
                    ></span>
                  </h2>
                </td>
              </tr>
